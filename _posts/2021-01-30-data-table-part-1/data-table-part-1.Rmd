...
In `data.table`, the solution to creating multiple columns is to [specify columns of interest into `.SDcols` and then loop through each column using `lapply(function)`](https://stackoverflow.com/questions/68055613/transform-multiple-columns-and-return-all-columns-using-data-table-in-r/68055663#68055663).      
